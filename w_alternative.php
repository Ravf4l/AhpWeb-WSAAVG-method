...
<section class="content">
	<h2 class="ui header">Alternative Comparison &rarr; <?php echo getCriteriaName($type-1) ?></h2>
	<?php showTabelRatio($type,'alternative'); ?>
</section>
	...
	<table class="ui collapsing striped red table">
		...
		<tbody>
			...
			<tr>
				...
				<td>Equally to moderately preferred</td>
			</tr>
			<tr>
